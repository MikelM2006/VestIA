...
export const GEMINI_API_KEY = "AIzaSyAJGaU0vx3_o0vX5muSVlU0RDlVXuJiPx8";

// MODELO 2: Para Imágenes (Multimodal potente)
export const GEMINI_VISION_URL = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-lite:generateContent";
